...
const ContactInformation = () => {
    return (
        <div id='Contact' className='max-w-6xl mx-auto'>
            <h1 className='text-4xl text-white font-bold text-center my-10'>Get In Touch</h1>
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-5'>
                <div className='p-10 space-y-6'>
                    ...
                    <h1 className='flex gap-2 items-center text-white'><CiLinkedin className='text-sky-500 text-3xl' /> https://www.linkedin.com/in/jubaer-ahmed-54b457293</h1>
                    <h1 className='flex gap-2 items-center text-white'><FaGithub className=' text-2xl' /> https://github.com/jubaer131 </h1>
                    ...
                    <div className="w-full max-w-xl p-8 space-y-3 rounded-xl dark:bg-gray-50 dark:text-gray-800">
                        <form noValidate="" action="" className=" border-2 p-5 border-white">
                            <div className="space-y-8 my-5">
                                ...
                                <div>
                                    <button className='btn w-full bg-white text-black'>Send Message</button>
                                </div>
                            </div>
